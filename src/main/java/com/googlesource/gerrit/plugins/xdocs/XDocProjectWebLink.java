...
public class XDocProjectWebLink implements ProjectWebLink {
  ...
  private final LoadingCache<XDocResourceKey, Resource> docCache;

  @Inject
  XDocProjectWebLink(
      @PluginName String pluginName,
      GitRepositoryManager repoManager,
      @Named(XDocLoader.Module.X_DOC_RESOURCES) LoadingCache<XDocResourceKey, Resource> cache) {
    ...
    try {
      ...
      try {
        ...
        Resource rsc = docCache.getUnchecked(
            new XDocResourceKey(p, "README.md", revId));
